(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('koishi-adapter-onebot'), require('koishi-plugin-puppeteer'), require('koishi-core'), require('dayjs'), require('querystring'), require('koishi'), require('react-dom/server'), require('react'), require('path'), require('node-sass'), require('marked'), require('highlight.js'), require('html-entities'), require('util'), require('stream'), require('zlib'), require('assert'), require('buffer'), require('crypto')) :
  typeof define === 'function' && define.amd ? define(['exports', 'koishi-adapter-onebot', 'koishi-plugin-puppeteer', 'koishi-core', 'dayjs', 'querystring', 'koishi', 'react-dom/server', 'react', 'path', 'node-sass', 'marked', 'highlight.js', 'html-entities', 'util', 'stream', 'zlib', 'assert', 'buffer', 'crypto'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['koishi-plugin-work'] = {}, null, null, global.koishiCore, global.dayjs, global.querystring, global.koishi, global.server, global.React, global.path, global.sass, global.marked, global.hljs, global.htmlEntities, global.util, global.stream, global.zlib, global.assert, global.buffer, global.crypto));
}(this, (function (exports, koishiAdapterOnebot, koishiPluginPuppeteer, koishiCore, dayjs, querystring, koishi, server, React, path, sass, marked, hljs, htmlEntities, util, stream, zlib, assert, buffer, crypto) { 'use strict';
    ...
    _createClass(RenderTool, [{
      ...
      value: function renderStyles() {
        ...
        for (var id in styles) {
          stylesStr += "<style>".concat(sass__default['default'].renderSync({
            file: path__default['default'].resolve.apply(path__default['default'], _toConsumableArray(styles[id]))
          }).css.toString(), "</style>");
        }
  ...
  marked__default['default'].setOptions({
      highlight(code, lang, callback) {
          if (lang !== '') {
              return hljs__default['default'].highlight(code, { language: lang }).value;
          }
  ...
  const TodoCard = ({ todo }) => {
      ...
      return (React__namespace.createElement("div", { className: "todo-card" },
          React__namespace.createElement("h2", { className: "title" },
              React__namespace.createElement("span", { className: "status" }, todo.status === 'processing' ? '❎' : '✅'),
              React__namespace.createElement("span", { className: "el-tag el-tag--success" }, todo.id)),
          React__namespace.createElement("h2", { className: "title" }, todo.name),
          todo.tags.length > 0 &&
              React__namespace.createElement("h3", null, todo.tags.map((tag, index) => React__namespace.createElement("span", { key: index, className: "el-tag" }, tag))),
          React__namespace.createElement("h3", null, "\u4ECB\u7ECD"),
          React__namespace.createElement("div", { className: "desc markdown-body", dangerouslySetInnerHTML: {
                  __html: marked__default['default'](htmlEntities.decode(todo?.desc ?? '未描述内容'))
              } }),
          React__namespace.createElement("div", { className: "designator" },
              React__namespace.createElement("h3", null, "\u6307\u6D3E\u4EBA"),
              React__namespace.createElement("span", { className: "content" },
                  todo.designator?.qq ?
                      React__namespace.createElement("img", { className: "avatar", src: `http://q.qlogo.cn/headimg_dl?dst_uin=${todo.designator?.qq}&spec=640`, alt: "" }) : '',
                  React__namespace.createElement("span", { className: "el-tag" }, todo.designator?.qq ?? '无指派人'))),
          React__namespace.createElement("div", { className: "datetime" }, dayjs__default['default'](todo.ctime).format('YYYY-MM-DD HH:mm:ss'))));
  };
  ...
  const StaticTodos = ({ todos }) => {
      ...
      return (React__namespace.createElement("div", { className: "staticTodosTemplate" },
          ...
          React__namespace.createElement("h2", null,
              React__namespace.createElement("label", null,
                  ...
                  " / ",
                  sumTodos),
              React__namespace.createElement("div", { className: "bar" },
                  React__namespace.createElement("div", { className: "cur-process", style: {
                          width: `${finishedTodos.length / sumTodos * 100}%`
                      } }))),
          todos.map(todo => React__namespace.createElement(TodoCard, { key: todo.id, todo: todo }))));
  };
  ...
  const registerTodosRoutes = (ctx) => {
      ...
      koaRouter.use(async (koaCtx, next) => {
          if (/^\/work\/.*/.test(koaCtx.path)) {
              ...
              if (content.$$typeof === Symbol.for('react.element')) {
                  content = server.renderToString(content);
                  koaCtx.body = `
          <head>
            <title></title>
      ...
      koaRouter.get('/work/:qqNum/todos/:tag', async (koaCtx, next) => {
          ...
          return (React__namespace.createElement("body", { style: {
                  width: '800px'
              } },
              React__namespace.createElement(StaticTodos, { todos: todos })));
      });
  };
  ...
  ***************************************************************************** */
  ...
  let assert = assert__default['default'].ok;



  let kMaxLength = buffer__default['default'].kMaxLength;
          ...
          return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                ...
                case 7:
                  this.images.push(koishi.segment.image(buffer));
  ...
  koishiCore.User.extend(function () {
    return {
      todos: []
    };
  });
  ...
  var listTodos = function listTodos(todos, tag, options) {
    ...
    if (options !== null && options !== void 0 && options.week && !options.mouth) {
      todos = todos.filter(function (todo) {
        return !dayjs__default['default'](todo.ctime).isBefore(dayjs__default['default']().add(-7, 'day'));
      });
    }

    if (options !== null && options !== void 0 && options.mouth) {
      todos = todos.filter(function (todo) {
        return !dayjs__default['default'](todo.ctime).isBefore(dayjs__default['default']().add(-30, 'day'));
      });
    }
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 12:
                ...
                url = "http://localhost:13333/work/".concat(u.onebot, "/todos/").concat(tag !== null && tag !== void 0 ? tag : 'all', "?").concat(querystring__namespace.stringify(options));
                _context3.next = 16;
